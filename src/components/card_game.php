            <div class="<?= $css ?? '' ?> text-white flex relative overflow-hidden">
                <?php if (isset($toptext)) : ?>
                <label class="top-0 right-0 whitespace-nowrap absolute">
                    <span class="block translate-y-10 translate-x-16 origin-center rotate-30 text-neutral-800 bg-amber-400 border-t-1 border-white text-center w-[310px] py-2 shadow-jdsgray-500/50"><?= $toptext ?></span>
                </label>
                <?php endif; ?>
