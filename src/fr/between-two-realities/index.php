...
<body>
    <header class="fixed w-full">
        <nav class="bg-gray-200 border-gray-200 py-2.5 dark:bg-neutral-900">
            <div class="flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto">
                <a href="#" class="flex items-center">
                    <img src="../../images/logo.svg" class="h-6 mr-3 sm:h-9" alt="Schizogame Logo">
                    <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Schizogame</span>
                </a>
                ...
                <div class="items-center justify-between hidden w-full lg:flex lg:w-auto lg:order-1" id="mobile-menu-2">
                    <ul class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                        ...
                        <li>
                            <a href="#game" class="block py-2 pl-3 pr-4 text-gray-700 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-purple-700 lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700">Jeux</a>
                        </li>
                        <li>
                            <a href="#more" class="block py-2 pl-3 pr-4 text-gray-700 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-purple-700 lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700">Plus</a>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <!-- Start block -->
    <section class="bg-gray-300 dark:bg-neutral-700">
        ...
        <div class="items-center max-w-screen-xl px-4 py-8 mx-auto lg:py-24 lg:px-6">
            ...
            <div class="col-span-2 space-y-8 md:grid md:grid-cols-3 lg:grid-cols-4 md:gap-12 md:space-y-0">
                <div>
                    ...
                    <p class="font-light text-gray-800 dark:text-gray-400">La schizophrénie peut avoir une composante génétique. Les antécédents familiaux peuvent augmenter le risque mais d’autres facteurs biopsychosociaux comme par exemple l’environnement, des facteurs biologiques, le stress ou encore la consommation de substances jouent également un rôle dans l’apparition ou la gravité du trouble.</p>
                </div>
                <div>
                ...
                <div>
                    ...
                    <p class="font-light text-gray-800 dark:text-gray-400">Les traitements médicamenteux comme les antipsychotiques sont essentiels pour réduire les symptômes de la schizophrénie. Ils ne « guérissent » pas la maladie mais aide à stabiliser l’état de la personne et à améliorer sa qualité de vie. Il faut être attentif à la présence et à la gestion de potentiels effets secondaires de tels médicaments.</p>
                </div>
                <div>
    ...
    <section class="bg-gray-300 dark:bg-neutral-800">
        <div class="max-w-screen-xl px-4 py-8 mx-auto space-y-12 lg:space-y-20 lg:py-24 lg:px-6">
            <!-- Row -->
            <div class="items-center">
                <div class="text-gray-800 sm:text-lg dark:text-gray-400">
                    ...
                    <div class="">
                        ...
                        <div class="mb-8">
                            <span class="font-semibold text-gray-950 dark:text-gray-300">Les symptômes positifs</span> qui représentent une distorsion ou un excès des fonctions normales :
                        ...
                        <div class="mb-8">
                            <span class="font-semibold text-gray-950 dark:text-gray-300">Symptômes associés à la désorganisation</span> :
                        ...
                        <div class="mb-8">
                            <span class="font-semibold text-gray-950 dark:text-gray-300">Les symptômes négatifs</span> qui représentent une diminution ou une perte des fonctions normales :
                        ...
                        <div class="mb-8">
                            <span class="font-semibold text-gray-950 dark:text-gray-300">Troubles cognitifs</span> :
    ...
    <footer class="bg-gray-100 dark:bg-neutral-900">
        <div class="max-w-screen-xl p-4 py-6 mx-auto lg:py-16 md:p-8 lg:p-10">
            ...
            <div class="text-center">
                ...
                <span class="block text-sm text-center text-gray-500 dark:text-gray-400">© 2025 Schizogame
                </span>
                <!--
...
/*
    window.addEventListener('resize', function(event) {
        ...
        iframe = document.querySelector('.game-frame iframe');
